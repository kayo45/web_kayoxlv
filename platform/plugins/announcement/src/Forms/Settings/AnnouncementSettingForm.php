    ...
    public function buildForm(): void
    {
        ...
        $this
            ...
            ->add('announcement_placement', 'select', [
                ...
                'value' => old('announcement_placement', setting('announcement_placement', AnnouncePlacement::TOP)),
                'colspan' => 2,
            ])
            ->add('announcement_text_alignment', 'select', [
                ...
                'value' => old('announcement_text_alignment', setting('announcement_text_alignment', TextAlignment::CENTER)),
                'colspan' => 2,
            ])
            ...
            ->add('announcement_max_width_unit', 'select', [
                ...
                'value' => old('announcement_max_width_unit', setting('announcement_max_width_unit', 'px')),
            ])
            ...
            ->add('announcement_font_size_unit', 'select', [
                ...
                'value' => old('announcement_font_size_unit', setting('announcement_font_size_unit', 'rem')),
            ])
